...
class EditComputerCrash extends Component{
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        ...
        then(data => {this.setState({
            ...
            if(this.state.status == "Gotowa do odbioru" || this.state.status == "Nie nadaje się do naprawy"){
            this.setState({
                editCost: true
            })
        }})
...
export default EditComputerCrash;