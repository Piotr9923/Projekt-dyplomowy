...
class HomeCrashInfo extends Component{
    constructor(props) {
        super(props);
    ...
    CrashInfo=()=>{
        ...
        return(
            <div>
            <Link to={"/staff/home-crash/"+this.props.match.params.id+"/edit"}><Edit fontSize="large"/></Link>
    ...
    ClientInfo=()=>{
        ...
        return(
            ...
            {this.state.info.clientAddress}<br/>
