...
class AnnouncementListView extends Component{
    ...
    render() {
        if(this.state.isLoading){
            ...
            return(<div><ClientHeader/><br/><h2 className="centered" style={{color:"red"}}>Nie można pobrać ogłoszeń! Spróbuj ponowanie później!</h2></div>)
        }
